...
def saturate(inp: float, sat: float):
    if inp > sat:
        return (sat, True)
    if inp < - sat:
        return (-sat, True)
...
class P_Controller:
    ...
    def __init__(self, _kp: float, _sat: float = None):
        self.kp = _kp
...
class PI_Controller:
    ...
    def __init__(self, _kp: float, _ki: float, _sat: float = None):
        self.kp = _kp
        self.ki = _ki
        self.i = Integrator()
        self.saturation = _sat
...
class PID_Controller:
    ...
    def __init__(self, _kp: float, _ki: float, _kd : float, _sat: float = None):
        self.kp = _kp
        self.ki = _ki
        self.kd = _kd
        self.saturation = _sat
